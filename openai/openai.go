...
3. Use the key 'issue_key' for each issue or task (e.g., "ABC-123", "ABC-456").
...
Example JSON Response:
{
	...
	"ABC-123": "This task involved managing roles in the identity management system and primarily impacts the areas of user access and permissions.",
	"ABC-456": "This task focused on tracking login activities, affecting the system's security and compliance."
}`
